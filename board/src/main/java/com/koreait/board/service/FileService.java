...
// 코드 환경 외부에 저장된 데이터를 가져올 때, 환경 변수
...
//     @Value("${file.path}") // 코드 환경 외부에 저장된 데이터를 가져올 때, 환경 변수
...
//         //? 원본 확장자명 (image.png) 
//         String extension = originalFileName.substring(originalFileName.lastIndexOf(".")); // .뒤에 png 가져옴
